 ...
 *  11.  trustmodel_redteam_evaluate    — POST /api/v1/red-team/evaluations/    (TRUS-726)
 *  12.  trustmodel_redteam_results     — GET  /api/v1/red-team/evaluations/{int}/
 *  13.  trustmodel_redteam_list_probes — GET  /api/v1/red-team/probes/
 *  14.  trustmodel_shadowai_scan       — POST /api/v1/shadow-ai/scans/          (TRUS-756)
 *  15.  trustmodel_shadowai_results    — GET  /api/v1/shadow-ai/scans/{int}/
 *  16.  trustmodel_shadowai_events     — GET  /api/v1/shadow-ai/scans/{int}/events/
 *
...
// Tool 11 — trustmodel_redteam_evaluate (TRUS-726)
server.tool(
  redteamEvaluateToolName,
  redteamEvaluateToolDescription,
  redteamEvaluateToolSchema,
...
// Tool 12 — trustmodel_redteam_results (TRUS-726)
server.tool(
  redteamResultsToolName,
  redteamResultsToolDescription,
  redteamResultsToolSchema,
...
// Tool 13 — trustmodel_redteam_list_probes (TRUS-726)
server.tool(
  redteamProbesToolName,
  redteamProbesToolDescription,
  redteamProbesToolSchema,
...
// Tool 14 — trustmodel_shadowai_scan (TRUS-756)
server.tool(
  shadowaiScanToolName,
  shadowaiScanToolDescription,
  shadowaiScanToolSchema,
...
// Tool 15 — trustmodel_shadowai_results (TRUS-756)
server.tool(
  shadowaiResultsToolName,
  shadowaiResultsToolDescription,
  shadowaiResultsToolSchema,
...
// Tool 16 — trustmodel_shadowai_events (TRUS-756)
server.tool(
  shadowaiEventsToolName,
  shadowaiEventsToolDescription,
  shadowaiEventsToolSchema,
